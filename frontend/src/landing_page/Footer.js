       ...
       <div className="container mt-5 border-top bg-light">
            <div className="row mt-5 text-center text-md-start">
                <div className="col-md-3 mb-4">
                    <img src="media/images/logo1.png" className="img-fluid rounded-circle" style={{width:"50"}} alt="Logo" />
                    <p>&copy; 2010 - 2025, Stockscope Broking Ltd. All rights reserved.</p>
                </div>
                <div className="col-md-3 mb-4">
            ...
            <div className='mt-5 text-small text-muted' style={{ fontSize: "14px" }}>
                <p>Stockscope Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Stockscope Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through Stockscope Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.: INZ000038238 Registered Address: Stockscope Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India.</p>
